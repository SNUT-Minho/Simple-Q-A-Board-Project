<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardWriteFromControl.ascx.cs" Inherits="DotNetNote.DotNetNote.BoardWriteFromControl" %>
<style>
    html{
        min-width:500px;
    }
...
<h2>게시판</h2>
<span style="color: red">글 쓰기 - 다음 필드들을 채워주세요.</span>
<hr />
<table style="width: 600px; border-collapse: collapse; padding: 5px; margin-left: auto; margin-right: auto;">
    ...
    <tr>
        ...
        <td style="padding-left: 10px">
            <asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" Height="200px" Width="480px" CssClass="form-control" Style="display: inline-block" colums="50"></asp:TextBox>
            <br />
